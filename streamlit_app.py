...
ax.set_title("Graph of monthly net revenue against month")
...
ax.set_title("Graph of Monthly Invoices Against Month")
ax.tick_params(axis="x", rotation=45)
st.pyplot(fig)
...
ax.set_title("Graph of Average Monthly Invoice Value Against Month")
ax.tick_params(axis="x", rotation=45)
st.pyplot(fig)
...
ax.set_title("Graph of Average Monthly Units per Invoice Against Month")
ax.tick_params(axis="x", rotation=45)
st.pyplot(fig)
